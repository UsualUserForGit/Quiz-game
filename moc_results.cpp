...
#include <memory>
#include "../../Qt_Projects(c++)/quiz_game/results.h"
...
QT_MOC_LITERAL(1, 8, 19), // "escape_from_results"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 19), // "exit_button_Clicked"
QT_MOC_LITERAL(4, 49, 24) // "main_menu_button_Clicked"

    },
    "results\0escape_from_results\0\0"
    "exit_button_Clicked\0main_menu_button_Clicked"
};
...
void results::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->escape_from_results(); break;
        case 1: _t->exit_button_Clicked(); break;
        case 2: _t->main_menu_button_Clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&results::escape_from_results)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void results::escape_from_results()
{
